...
* [`src/clj/rdd/`](src/clj/rdd/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/rdd/`](src/cljs/rdd/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/rdd/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `rdd` project root directory
...
in the [`src/clj/rdd/`](src/clj/rdd/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/rdd/config.cljs) defaults to `true` in
